<?php
/*
Plugin Name: Icreon Functions
Plugin URI: https://github.com/abstractwp/wpe-icr
Description: Project specific functions plugin for this site
Version: 0.1.0
Author: Abstract WP
Author URI: https://www.abstractwp.com
Text Domain: icr-functions
...
include "types/type-career.php";
include "types/type-case-study.php";
include "types/type-client.php";
include "types/type-industry.php";
 ...
 *
 */
function icr_disable_default_dashboard_widgets() {
...
add_action('wp_dashboard_setup', 'icr_disable_default_dashboard_widgets', 999);
...
add_action( 'wp_before_admin_bar_render', 'icr_admin_bar_render' );
 ...
 *
 */
function icr_remove_howdy( $wp_admin_bar ) {
...
add_filter( 'admin_bar_menu', 'icr_remove_howdy',25 );
 ...
 *
 */
function icr_hide_events_calendar_dashboard_widgets() {
...
add_action('wp_dashboard_setup', 'icr_hide_events_calendar_dashboard_widgets', 20);
